...
[unreleased]: https://github.com/dieter-medium/bidi2pdf-rails/compare/v0.1.6..HEAD
...
- Enforce forced shutdown for chromedriver by @dieter-medium

### 🐛 Fixed

- Correct Chromedriver URL fallback logic by @dieter-medium
  in [#22](https://github.com/dieter-medium/bidi2pdf-rails/pull/22)
- Add specs for session warmer integration by @dieter-medium

### 🚀 Added

- Add session warmer support and configuration options by @dieter-medium

[0.1.6]: https://github.com/dieter-medium/bidi2pdf-rails/compare/v0.1.5..v0.1.6
